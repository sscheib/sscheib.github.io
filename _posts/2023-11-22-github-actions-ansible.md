...
Can you spot the error already? Right, I have indented the first task by one space more than the others. Let's see what `ansible-playbook --syntax-check playbook.yml` has
